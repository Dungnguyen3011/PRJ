                            ...
                            <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <c:set var="o" value="${sessionScope.d}"></c:set>
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền hàng</strong><strong>${o.amount*o.price}</strong></li>
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">${o.amount*o.price + 5} $</h5>
                                        </li>
